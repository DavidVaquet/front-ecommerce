...
export const SubirProducto = () => {
  ...
  const subcategoriaFilter = subcategorias.filter(
    (sub) => sub.categoria_id === parseInt(category_id)
  );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <Typography color="gray" className="mt-1 font-normal text-sm">
                  Completá los siguientes datos para añadir un nuevo producto al
                  sistema.
                </Typography>
              </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                            <Chip
                              variant={destacado === 1 ? "filled" : "outlined"}
                              value="SI"
                              onClick={() => setDestacado(1)}
                              color="green"
                              className={`rounded-full cursor-pointer ${
                                destacado
                                  ? "bg-green-500 text-white"
                          ...
                          <div className="flex items-center gap-2">
                            <Chip
                              variant={destacado === 0 ? "filled" : "outlined"}
                              value="NO"
                              onClick={() => setDestacado(0)}
                              color="red"
                              className={`rounded-full cursor-pointer ${
                                destacado ? "" : "border-gray-300 text-white"
                              }`}
                            />
                          </div>
                        </div>
